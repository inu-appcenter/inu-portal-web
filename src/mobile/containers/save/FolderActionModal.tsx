...
export default function FolderActionModal({ onAddFolder, onManageFolders, onClose }: FolderActionModalProps) {
  return (
    <Overlay>
      <ModalWrapper>
        <ModalHeader>
