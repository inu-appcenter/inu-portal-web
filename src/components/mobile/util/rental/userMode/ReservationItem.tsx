...
const ReservationItem = ({
  ...
  return (
    <ReservationItemWrapper>
      <InfoContainer>
        <Info>
          <strong>물품 이름:</strong> {itemName}
        </Info>
        <Info>
          <strong>대여 일자:</strong>{" "}
          {new Date(reservation.startDateTime).toLocaleString("ko-KR", {
            year: "numeric",
            month: "long",
            day: "numeric",
            hour: "2-digit",
        ...
        <Info>
          <strong>반납 일자:</strong>{" "}
          {new Date(reservation.endDateTime).toLocaleString("ko-KR", {
            year: "numeric",
            month: "long",
            day: "numeric",
            hour: "2-digit",
        ...
        <Info>
          <strong>예약 상태:</strong>{" "}
          {reservation.reservationStatus === "CONFIRM"
            ? "승인"
