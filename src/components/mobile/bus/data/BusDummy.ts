...
export const goSchool_INU2: BusData[] = [
  ...
  },
  {
    ...
    path: [
      ...
      { lat: 37.37171, lng: 126.63345 }, //공대
    ],
    stopMarker: [
      { name: "인입", lat: 37.38548, lng: 126.63871 },
  ...
  },
  {
    ...
    stopMarker: [
      { name: "인입", lat: 37.38548, lng: 126.63871 },
      { name: "북문", lat: 37.37914, lng: 126.63201 },
...
export const goSchool_BIT3: BusData[] = [
  {
    ...
    stopMarker: [
      { name: "지정단", lat: 37.37862, lng: 126.6452 },
      { name: "자연대", lat: 37.37497, lng: 126.63651 },
      { name: "공대", lat: 37.37318, lng: 126.63481 },
    ],
...
export const goHome_MainIn: BusData[] = [
  {
    ...
    stopMarker: [
      { name: "정문", lat: 37.37764, lng: 126.63524 },
      { name: "탐스", lat: 37.38348, lng: 126.64173 },
      { name: "인입", lat: 37.38547, lng: 126.63872 },
    ],
    routeId: "164000004",
    sectionLabel: "정문",
...
export const goHome_Dorm1: BusData[] = [
  ...
  },
  {
    ...
    stopMarker: [
      { name: "송도캠", lat: 37.37376, lng: 126.63108 },
      { name: "북문", lat: 37.37816, lng: 126.63128 },
      { name: "인입", lat: 37.38514, lng: 126.63891 },
    ],
    routeId: "165000514",
    sectionLabel: "송도캠",
    stopId: "go-home-dorm",
...
export const goHome_Nature_BIT: BusData[] = [
  {
    ...
    stopMarker: [
      { name: "공대", lat: 37.37239, lng: 126.63449 },
      { name: "자연대", lat: 37.37429, lng: 126.6363 },
      { name: "지정단", lat: 37.37893, lng: 126.64442 },
    ],
  ...
  },
  {
    ...
    stopMarker: [
      { name: "공대", lat: 37.37239, lng: 126.63449 },
      { name: "자연대", lat: 37.37429, lng: 126.6363 },
      { name: "지정단", lat: 37.37678, lng: 126.64654 },
    ],
    routeNotice: "많이 돌아가는 노선이니 주의하세요!",
    routeId: "165000007",
    sectionLabel: "자연대",
