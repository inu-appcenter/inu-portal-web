...
const InfoWindowRestaurant = (place: Place, imagesrc: any) => `
  <div style="font-family: 'Helvetica Neue', Arial, sans-serif; line-height: 1.5; color: #333; width: 200px; padding: 10px; overflow: hidden;">
    ...
    <div style="margin-top: 15px; text-align: center; min-height: 120px;">
      <img src="${imagesrc}" alt="식당 이미지" style="width: 100%; max-width: 180px; height: auto; min-height: 120px; display: block; margin: 0 auto; border-radius: 8px;"/>
    </div>
  </div>
`;
