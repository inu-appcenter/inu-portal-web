...
export const places: Place[] = [
  ...
  },
  {
    ...
    schoolPlaceInfo: [
      ...
      {
        name: "정보통신공학과",
        link: "https://www.example.com/정보통신공학과",
      },
      {
        name: "임베디드시스템공학과",
        link: "https://www.example.com/임베디드시스템공학과",
      },
    ],
    cafePlaceInfo: null, // 추가된 필드
    restaurantInfo: null, // 추가된 필드
  ...
  },
  {
    ...
    schoolPlaceInfo: [
      ...
      {
        name: "산업경영공학과",
        link: "https://www.example.com/산업경영공학과",
      },
      { name: "신소재공학과", link: "https://www.example.com/신소재공학과" },
      { name: "안전공학과", link: "https://www.example.com/안전공학과" },
      {
        name: "에너지화학공학과",
        link: "https://www.example.com/에너지화학공학과",
      },
      {
        name: "바이오-로봇 시스템 공학과",
        link: "https://www.example.com/바이오-로봇 시스템 공학과",
      },
    ],
    cafePlaceInfo: null, // 추가된 필드
    restaurantInfo: null, // 추가된 필드
  ...
  },
  {
    ...
    schoolPlaceInfo: [
      ...
      {
        name: "미디어커뮤니케이션학과",
        link: "https://www.example.com/미디어커뮤니케이션학과",
      },
      { name: "문헌정보학과", link: "https://www.example.com/문헌정보학과" },
      {
        name: "창의인재개발학과",
        link: "https://www.example.com/창의인재개발학과",
      },
  ...
  },
  {
    ...
    schoolPlaceInfo: [
      ...
      {
        name: "테크노경영학과",
        link: "https://www.example.com/테크노경영학과",
      },
      {
        name: "동북아국제통상전공",
        link: "https://www.example.com/동북아국제통상전공",
      },
      {
        name: "스마트물류공학전공",
        link: "https://www.example.com/스마트물류공학전공",
      },
  ...
  },
  {
    ...
    schoolPlaceInfo: [
      ...
      {
        name: "일본지역문화학과",
        link: "https://www.example.com/일본지역문화학과",
      },
  ...
  },
  {
    ...
    schoolPlaceInfo: [
      {
        name: "한국화전공(조형예술학부)",
        link: "https://www.example.com/한국화전공",
      },
      {
        name: "서양화전공(조형예술학부)",
        link: "https://www.example.com/서양화전공",
      },
  ...
  },
  {
    ...
    schoolPlaceInfo: [
      ...
      {
        name: "국제자유전공학부",
        link: "https://www.example.com/국제자유전공학부",
      },
  ...
  },
  {
    ...
    schoolPlaceInfo: [
      {
        name: "생명과학부(생명과학전공)",
        link: "https://www.example.com/생명과학부(생명과학전공)",
      },
      {
        name: "생명과학부(분자의생명전공)",
        link: "https://www.example.com/생명과학부(분자의생명전공)",
      },
      {
        name: "생명공학부(생명공학전공)",
        link: "https://www.example.com/생명공학부(생명공학전공)",
      },
      {
        name: "생명공학부(나이오바이오공학전공)",
        link: "https://www.example.com/생명공학부(나이오바이오공학전공)",
      },
    ],
    cafePlaceInfo: null, // 추가된 필드
    restaurantInfo: null, // 추가된 필드
