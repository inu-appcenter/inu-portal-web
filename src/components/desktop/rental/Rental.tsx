...
import ItemList from "@/components/mobile/util/rental/userMode/ItemList.tsx";
import RentalTab from "@/components/mobile/util/rental/RentalTab.tsx";
import NoticeBox from "@/components/mobile/util/rental/userMode/NoticeBox.tsx";
    ...
    <Wrapper>
      ...
      {!isOpenAdminPage && (
        <>
          ...
          >
            {!isOpenedList ? <>내 예약 목록 보기</> : <>내 예약 목록 닫기</>}
          </Button>
